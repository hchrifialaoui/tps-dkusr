...
Elle nous dit qu'il y a actuellement 0 conteneur Docker qui s'exécute sur la machine et que nous ne possédons qu'une image à l’heure actuelle. Nous reviendrons plus tard sur ce qu'est une image et comment il est possible de les utiliser pour construire des conteneurs.
